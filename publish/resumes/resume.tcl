# ------ RUN 'tcl resume.tcl' TO CHECK RESUME AUTHENTICITY ------------
set _ {
...
set c 0; foreach e [split $_] {if {$e != {}} {incr c}}
if {"5231704" == "[string length $_]$c"} {
         puts "This resume seems to be healthy and intact"
} else { puts "Some ne'er-do-well has altered this resume" }
