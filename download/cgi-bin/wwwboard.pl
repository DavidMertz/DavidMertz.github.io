...
$basedir = "/home/98/46/2924698/web/wwwboard";
$baseurl = "http://gnosis.cx/wwwboard";
$cgi_url = "/cgi-gnosis/wwwboard.pl";
...
sub get_variables {
   ...
   ($sec,$min,$hour,$mday,$mon,$year,$wday,$yday,$isdst) = localtime(time); $year = 1900 + $year;
...
sub new_file {
   ...
   print NEWFILE "  </head>\n";
   print NEWFILE "  <body background='../../home/MarbleBack.jpg'>\n";
