...
dirUpload = "upload-tpip"       # directory for upload; will be created if doesn't exist
maxkb = 8000                    # maximum kilobytes to store before no more files accepted
...
def form(posturl,files,kb,maxkb,button):
    ...
    print """<html>
<head>
<title>TPiP Upload</title>
<body>

<h2>UPLOAD BOOK DRAFT FILES:</h2>
