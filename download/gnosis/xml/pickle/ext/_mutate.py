...
from types import *
from gnosis.util.introspect import isInstanceLike, hasCoreData, py_version
...
def get_mutator(obj):
    ...
    # Bools (Python 2.3) are a special case - they look like a newstyle
    ...
    if py_version >= '2.3' and type(obj) is BooleanType:
        return None
